...
public final class ItemTaskBinding implements ViewBinding {
  ...
  private ItemTaskBinding(@NonNull MaterialCardView rootView, @NonNull TextView taskDate,
      @NonNull TextView taskDescription, @NonNull TextView taskStatus,
  ...
  public static ItemTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTaskBinding((MaterialCardView) rootView, taskDate, taskDescription, taskStatus,
          taskTitle);
    }
